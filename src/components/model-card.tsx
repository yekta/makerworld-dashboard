...
function ModelCardContent(props: TProps) {
  ...
  return (
    ...
    >
      ...
      <div className="opacity-0 z-0 transform translate-z-0 translate-x-1/2 -translate-y-1/2 transition-opacity duration-300 group-data-highlighted:opacity-100 absolute h-10 aspect-5/1 top-0 right-0 bg-success/20 group-data-travelled:bg-warning/20 blur-xl" />
      <div className="opacity-0 z-0 transform translate-z-0 translate-x-1/2 -translate-y-1/2 transition-opacity duration-300 group-data-highlighted:opacity-100 absolute h-20 aspect-5/1 top-0 right-0 bg-success/10 group-data-travelled:bg-warning/10 blur-2xl" />
