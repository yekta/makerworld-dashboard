...
export function TimeMachineButton({ className }: TProps) {
  ...
  return (
    ...
    >
      ...
      <ChevronDown className="size-4 shrink-0 text-muted-more-foreground -mr-1 group-data-open:rotate-180 transition-transform group-data-travelled:text-warning/50" />
    </Button>
  );
}
